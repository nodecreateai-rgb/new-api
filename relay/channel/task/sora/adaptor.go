...
func (a *TaskAdaptor) UseRequestBillingRatios(info *relaycommon.RelayInfo) bool {
	...
	case "sd2.5", "sd2-mini", "sd2-fast", "sd2-c6", "sd2-c7", "seedance-720", "seedance-2.0-mini", "seedance-2.0-mini-480p", "seedance-2.0-fast-720p", "seedance-2.0-720p", "seedance-2.0-1080p", "seedance-2.0", "seedance-2.5", "kling-o3":
		return false
	default:
		return true
	}
