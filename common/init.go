...
func resolveTaskPricePatches(raw string) []string {
	defaults := []string{
		...
		"sd2.5", "sd2-c8", "sd2-c9", "sd2-c10", "sd2-c11", "sd2-c12", "sd2-mini", "sd2-fast",
		"seedance-720", "seedance-2.0-mini", "seedance-2.0-mini-480p", "seedance-2.0-mini-480p-c2", "seedance-2.0-mini-720p-c2", "seedance-2.0-fast-480p", "grok-imagine-720p", "seedance-2.0-fast-720p", "seedance-2.0-720p", "seedance-2.0-1080p",
...
func initConstantEnv() {
	...
	constant.TaskTimeoutMinutes = GetEnvOrDefault("TASK_TIMEOUT_MINUTES", 120)
