...
func resolveTaskPricePatches(raw string) []string {
	defaults := []string{
		...
		"seedance-720", "seedance-2.0-mini", "seedance-2.0-mini-480p", "seedance-2.0-fast-720p", "seedance-2.0-720p", "seedance-2.0-1080p",
		...
		"seedance-2.0", "seedance-2.5", "seedance-2.0-c1", "seedance-2.5-c1", "seedance-2.5-c2",
		"pay", "oauth2",
	}
...
func initConstantEnv() {
	...
	constant.TaskTimeoutMinutes = GetEnvOrDefault("TASK_TIMEOUT_MINUTES", 60)
